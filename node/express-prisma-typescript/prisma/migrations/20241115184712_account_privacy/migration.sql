/*
  ...
  - You are about to drop the `UserPermissionType` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."UserPermission" DROP CONSTRAINT "UserPermission_typeId_fkey";
...
-- DropTable
DROP TABLE "public"."UserPermissionType";
